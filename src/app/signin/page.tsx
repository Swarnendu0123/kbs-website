                                ...
                                <form>
                                    <div className="grid gap-y-4">
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ms-3">
                                                <label htmlFor="remember-me" className="text-sm text-white">Remember me</label>
                                            </div>
                                        </div>
